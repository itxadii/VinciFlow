...
# 1. AUTHENTICATE WITH ECR (Strictly using cmd.exe for PowerShell compatibility)
...
# Local tag must match the one used in terraform 'docker build' command
docker tag vinciflow-app:latest "${repository_url}:latest"
